...
const VIEWS: AIKnowledgeView[] = [
	...
	},
	{
		...
		purpose: "Network, language, OpenRouter key, view seed, wipe",
		actions: [
	...
	},
	{
		...
		purpose: "Chat with LLM (OpenRouter)",
		actions: [
			"4 quick suggestions",
			"Input + send",
...
const SOURCES = [
	...
	{ name: "OpenRouter", purpose: "LLM completions (chat)", auth: "Bearer token (user's own key)" },
];
